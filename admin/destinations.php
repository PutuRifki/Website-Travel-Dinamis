                ...
                <div class="flex flex-row gap-5 items-center">
                    <div class="rounded-[100px] bg-[#D3FFE7] w-[84px] h-[84px] flex justify-center items-center">
                        <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M16.0302 19.0225C15.8552 19.005 15.6452 19.005 15.4527 19.0225C11.2877 18.8825 7.98022 15.47 7.98022 11.27C7.98022 6.9825 11.4452 3.5 15.7502 3.5C20.0377 3.5 23.5202 6.9825 23.5202 11.27C23.5027 15.47 20.1952 18.8825 16.0302 19.0225Z" stroke="#00AC4F" stroke-width="2.625" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M28.7172 7C32.1122 7 34.8422 9.7475 34.8422 13.125C34.8422 16.4325 32.2172 19.1275 28.9447 19.25C28.8047 19.2325 28.6472 19.2325 28.4897 19.25" stroke="#00AC4F" stroke-width="2.625" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M7.2805 25.48C3.0455 28.315 3.0455 32.935 7.2805 35.7525C12.093 38.9725 19.9855 38.9725 24.798 35.7525C29.033 32.9175 29.033 28.2975 24.798 25.48C20.003 22.2775 12.1105 22.2775 7.2805 25.48Z" stroke="#00AC4F" stroke-width="2.625" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M32.0947 35C33.3547 34.7375 34.5447 34.23 35.5247 33.4775C38.2547 31.43 38.2547 28.0525 35.5247 26.005C34.5622 25.27 33.3897 24.78 32.1472 24.5" stroke="#00AC4F" stroke-width="2.625" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
                    <div class="flex flex-col gap-2">
                        <p class="font-poppins text-[14px] tracking-[-0.01em] text-[#ACACAC]">Total Customers</p>
                        <p class="font-poppins font-semibold text-[32px] tracking-[-0.01em] text-[#333333]">5,423</p>
                    </div>
                </div>
                ...
                <div class="flex flex-row gap-5 items-center">
                    <div class="rounded-[100px] bg-[#D3FFE7] w-[84px] h-[84px] flex justify-center items-center">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M24.0664 31.7501L26.5997 34.2835L31.6664 29.2168" stroke="#00AC4F" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M20.2668 18.1173C20.1002 18.1007 19.9002 18.1007 19.7168 18.1173C15.7502 17.984 12.6002 14.734 12.6002 10.734C12.5835 6.65065 15.9002 3.33398 19.9835 3.33398C24.0668 3.33398 27.3835 6.65065 27.3835 10.734C27.3835 14.734 24.2168 17.984 20.2668 18.1173Z" stroke="#00AC4F" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M19.9829 36.3501C16.9496 36.3501 13.9329 35.5835 11.6329 34.0501C7.59958 31.3501 7.59958 26.9501 11.6329 24.2668C16.2162 21.2001 23.7329 21.2001 28.3162 24.2668" stroke="#00AC4F" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
                    <div class="flex flex-col gap-2">
                        <p class="font-poppins text-[14px] tracking-[-0.01em] text-[#ACACAC]">Members</p>
                        <p class="font-poppins font-semibold text-[32px] tracking-[-0.01em] text-[#333333]">1,893</p>
                    </div>
                </div>
                <div class="h-[87px] w-[2px] bg-[#D9DBE9]"></div>
                <div class="flex flex-row gap-5 items-center">
                    <div class="rounded-[100px] bg-[#D3FFE7] w-[84px] h-[84px] flex justify-center items-center">
                        <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M21 30.1348V38.4998" stroke="#00AC4F" stroke-width="2.625" stroke-linecap="round" stroke-linejoin="round"/>
